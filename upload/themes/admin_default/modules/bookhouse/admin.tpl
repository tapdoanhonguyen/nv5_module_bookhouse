...
<table class="table table-striped table-bordered table-hover">
	...
	<thead>
		<tr class="header">
			...
			<!-- END: head_td -->
			<td style="text-align: center"><strong>{LANG.admin_permissions}</strong>
			</td>
			<td>&nbsp;</td>
		</tr>
	</thead>
	<tbody>
		...
		<tr>
			...
			<td>
				<!-- BEGIN: is_admin --> <img style="vertical-align: middle;"
				alt="{CONTENT_TD.level}" title="{CONTENT_TD.level}"
				src="{NV_BASE_SITEURL}themes/{NV_ADMIN_THEME}/images/{CONTENT_TD.img}.png"
				width="38" height="18" /> <!-- END: is_admin -->{CONTENT_TD.username}
			</td>
			<td>{CONTENT_TD.full_name}</td>
			<td><a href="mailto:{CONTENT_TD.email}">{CONTENT_TD.email}</a></td>
			<td>{CONTENT_TD.admin_module_cat}</td>
			<td class="text-center">
				<!-- BEGIN: is_edit --> <em class="fa fa-edit fa-lg">&nbsp;</em><a
				href="{EDIT_URL}">{LANG.admin_edit}</a> <!-- END: is_edit -->
			</td>
		</tr>
		<!-- END: xusers -->
	</tbody>
...
<form method="post" enctype="multipart/form-data" action="">
	<table class="table table-striped table-bordered table-hover">
		...
		<tr>
			...
			<td>
				<!-- BEGIN: admin_module --> <label><input
					name="admin_module" value="{ADMIN_MODULE.value}" type="radio"{ADMIN_MODULE.checked}>{ADMIN_MODULE.text}</label>&nbsp;&nbsp;&nbsp;
				<!-- END: admin_module -->
			</td>
		</tr>
			...
			<tr>
				<td colspan="2">
					<table class="table table-striped table-bordered table-hover">
						...
						<thead>
							<tr>
								<th class="text-center">{LANG.admin_province}</th>
						...
						<tbody>
							<!-- BEGIN: province -->
							<tr>
								<td class="text-right">{CONTENT.type} {CONTENT.title}</td>
								<td class="text-center"><input type="checkbox"
									name="add_item[]" value="{CONTENT.provinceid}"{CONTENT.checked_add_item}></td>
								<td class="text-center"><input type="checkbox"
									name="app_item[]" value="{CONTENT.provinceid}"{CONTENT.checked_app_item}></td>
								<!--
                            <td class="text-center">
                                <input type="checkbox" name="pub_item[]" value="{CONTENT.provinceid}"{CONTENT.checked_pub_item}></td>
                            -->
								<td class="text-center"><input type="checkbox"
									name="edit_item[]" value="{CONTENT.provinceid}"{CONTENT.checked_edit_item}></td>
								<td class="text-center"><input type="checkbox"
									name="del_item[]" value="{CONTENT.provinceid}"{CONTENT.checked_del_item}></td>
							</tr>
							<!-- END: province -->
						</tbody>
					</table>
		...
		<tfoot>
			<tr>
				<td colspan="2" class="text-center"><input type="submit"
					value="{LANG.save}" name="submit" class="btn btn-primary"></td>
			</tr>
		</tfoot>
	</table>
</form>
