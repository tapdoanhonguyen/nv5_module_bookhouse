...
class Location
{
    ...
    {
        global $db, $db_config, $nv_Cache,$module_name,$lang;
        ...
        $sql = 'SELECT * FROM ' . NV_PREFIXLANG . '_' . $module_name . '_country WHERE status=1 ' . $where . ' ORDER BY weight ASC';
    ...
    {
        global $db, $db_config, $nv_Cache,$module_name;
        ...
        $sql = 'SELECT * FROM ' . NV_PREFIXLANG . '_' . $module_name . '_province WHERE status=1 ' . $where . ' ORDER BY weight ASC';
    ...
    public function getArrayDistrict($inArrayId = array(), $provinceid = 0)
    {
        ...
        $sql = 'SELECT * FROM ' . NV_PREFIXLANG . '_' . $module_name . '_district WHERE status=1 ' . $where . ' ORDER BY weight ASC';
    ...
    public function getArrayWard($inArrayId = array(), $districtid = 0)
    {
        ...
        $sql = 'SELECT * FROM ' . NV_PREFIXLANG . '_' . $module_name . '_ward WHERE status=1 ' . $where . ' ORDER BY title ASC';
    ...
    public function buildInput($template = 'default', $module = 'bookhouse')
    {
        ...
        include NV_ROOTDIR . '/modules/' . $module_name . '/language/admin_' . NV_LANG_INTERFACE . '.php';
